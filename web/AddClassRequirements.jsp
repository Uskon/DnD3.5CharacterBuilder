<%-- 
    Document   : AddClassRequirements
    Created on : Apr 22, 2013, 6:20:46 PM
    Author     : Uskon
--%>
...
<html>
    <head>
        ...
        <title>Add ${class.name}, ${class.ruleSet.name} Requirements</title>
    ...
    <body>
        <h1>Choose the ${class.name} (${class.ruleSet.name}) Requirements you wish to add</h1>
        <div class="bigdiv">
            <div class="leftside">
                <div class="inputfield">
                    <form name="addClassReqs"
                          action="${pageContext.request.contextPath}/AddClassRequirements"
                          method="post">
                        ...
                        <fieldset class="inputbox">
                            <p class="p1">Required Feat: <input type="text" name="feat" class="textinput"/></p>
                        </fieldset>
                        <%}
                        ...
                        <p>This Class has no requirements to be set</p>
                        <%} else {%>
            ...
            <div class="info">
                ...
                <table border ="1">     
                    ...
                    <c:forEach var="classreq" items="${classlist}">
                        <tr>
                            ...
                            <td>
                                <form action="${pageContext.request.contextPath}/RemoveClassRequirement"
                                  method="post">
                ...
                <table border ="1">     
                    ...
                    <c:forEach var="spellreq" items="${spelllist}">
                        <tr>
                            <td>${spellreq.id}</td>
                            <td>${spellreq.requiredClass.name}, (${spellreq.requiredClass.ruleSet.name}) ${spellreq.spellLvl}</td>
                            <td>
                                <form action="${pageContext.request.contextPath}/RemoveClassRequirement"
                                  method="post">
