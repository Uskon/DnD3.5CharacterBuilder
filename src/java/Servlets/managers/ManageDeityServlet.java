 ...
 * @author Uskon
 */
public class ManageDeityServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("deity") == null) {
            session.setAttribute("nullDeity", true);
            ...
            if (submit.equals("Set Domains")) {
                response.sendRedirect("AddNewDeityDomain");
            }
            if (submit.equals("Delete")) {
                response.sendRedirect("RemoveDeity");
            }
        }
    }
