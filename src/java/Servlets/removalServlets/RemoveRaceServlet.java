...
/**
 * Race-poistotapahtuman väliosa.
 * @author Uskon
 */
public class RemoveRaceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("race", em.getRaceByID(raceid));
        
        RequestDispatcher dispatcher = request.getRequestDispatcher("RemoveRace.jsp");
