...
/**
 * Hoitaa CClassin ClassProgressien poiston.
 * @author Uskon
 */
public class RemoveClassProgressServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/SetClassProgress").forward(request, response);
}
