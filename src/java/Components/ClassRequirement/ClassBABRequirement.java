 ...
 */
@Entity
public class ClassBABRequirement implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ClassBABRequirement)) {
            return false;
        }
        ClassBABRequirement other = (ClassBABRequirement) object;
