...
/**
 * Tarjoaa tiedot olemassaolevista CClasseista.
 * @author Uskon
 */
public class ManageClassesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!em.getClasses().isEmpty()) {
            request.setAttribute("classlist", em.getClasses());
        }
        RequestDispatcher dispatcher = request.getRequestDispatcher("ManageClassProperties.jsp");
