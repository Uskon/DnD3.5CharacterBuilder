...
/**
 * Skill-poistotapahtuman väliosa.
 * @author Uskon
 */
public class RemoveSkillServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("skill", em.getSkillByID(skillid));
        
        RequestDispatcher dispatcher = request.getRequestDispatcher("RemoveSkill.jsp");
