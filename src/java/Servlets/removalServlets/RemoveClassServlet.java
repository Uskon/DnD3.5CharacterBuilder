...
/**
 * CClass-poistotapahtuman väliosa.
 * @author Uskon
 */
public class RemoveClassServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("class", em.getClassByID(classid));
        
        RequestDispatcher dispatcher = request.getRequestDispatcher("RemoveClass.jsp");
