 ...
 * @author Uskon
 */
public class ManageFeatServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("feat") == null) {
            session.setAttribute("nullFeat", true);
            ...
            if (submit.equals("Set Requirements")) {
                response.sendRedirect("AddFeatRequirements");
            }
            if (submit.equals("Set Description")) {
                session.setAttribute("desctype", "feat");
                response.sendRedirect("AddDescription");
            }
            if (submit.equals("Delete")) {
                response.sendRedirect("RemoveFeat");
            }
        }
    }
